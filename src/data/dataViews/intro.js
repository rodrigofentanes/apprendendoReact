//class-based views
import JsInsideJsx  from '../../views/ExemplePages/JsInsideJsx';
import FunctionalComponent from '../../views/ExemplePages/FunctionalComponent';
import OtherComponent from '../../views/ExemplePages/OtherComponent';
import ClassBasedComponent  from '../../views/ExemplePages/ClassBasedComponent';
import PassingValuesFunctional from '../../views/ExemplePages/PassingValuesFunctional';
import ChildrenComponent from '../../views/ExemplePages/ChildrenComponent';
import StatePropertie from '../../views/ExemplePages/StatePropertie';
import ReRenderStateDOM from '../../views/ExemplePages/ReRenderStateDOM';
import PassingExternalMethod from '../../views/ExemplePages/PassingExternalMethod';
import ValueToFunction from '../../views/ExemplePages/ValueToFunction';
import TwoWayBind from '../../views/ExemplePages/TwoWayBind';
import ToggleContentJSX from '../../views/ExemplePages/ToggleContentJSX';
import ToggleContentJS from '../../views/ExemplePages/ToggleContentJS';
import OutputtingListWithMap from '../../views/ExemplePages/OutputtingListWithMap';
import ArrayManipulation from '../../views/ExemplePages/ArrayManipulation';

//functional views
import { ReRenderStateDOMIntoHook } from '../../views/ExemplePages/ReRenderStateDOMIntoHook';
